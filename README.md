...
Download metadata from https://amazon-reviews-2023.github.io/ and interaction data from https://amazon-reviews-2023.github.io/data_processing/0core.html

Save two downloaded files into ./datasets/{dataset_name}/src (Example filenames: meta_Baby_Products.jsonl.gz, Baby_Products.csv.gz)
...
[Obtain item textual embedding] Run python obtain_embeddings_st.py and an embedding document will be saved into the preprocessed directory
...
Under the folder of ./rec: Train on the original and augmented datasets

**[3] Recommendation Evaluation**

Under the folder of ./rec evaluate with test.py. The evaluation results will be automatically saved to files

The command examples for training and evaluation are in run.sh.
